...
Cross-validation results across three regression targets. PE Ratio is the only target with a positive LOO-CV R² (0.136), indicating ESG features carry generalizable signal   
for valuation ratios but not for raw stock price or market cap.
